...
import HeroSectionV2 from '@/components/services/components-v2/hero-section-v2';
import BenefitsSection from '@/components/services/components-v2/benefits-section';
import BeforeAfterSection from '@/components/services/components-v2/before-after-section';
    ...
    return (
        <>
            ...
            {showLegacy ? (
                ...
                <>
                    <HeroSectionV2 data={service} serviceId={service.serviceId} title={'Top Botox Services'} />
                    <BenefitsSection data={service.benefits} />
                    <BeforeAfterSection data={service.beforeAndAfter} />
