  ...
  return (
    <div className='relative h-full w-full'>
      ...
      <div className='absolute bottom-3 left-3 flex flex-col p-5'>
        ...
        <h5 className='font-display text-md font-light tracking-wide text-white'>
          {provider.title}
        </h5>
      </div>
    </div>
    ...
    <section className='bg-white py-20'>
      <Container classList='px-5'>
        ...
        <div className='mx-auto mt-0 mb-10'>
          <p className='text-center py-3 mx-5'>
            Our team at CADMEN is composed of highly trained professionals with years of experience in the cosmetic dermatology field. Each member is dedicated to providing personalized care and guiding you toward achieving your skin goals with precision, safety, and attention to detail.
          </p>
        </div>
        <Swiper
          slidesPerView={1}
