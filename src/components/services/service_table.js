...
const ServiceTable = ({ services, title }) => (
  <section className='relative pb-10 pt-32'>
    <h1 className='pb-10 text-center font-display text-5xl'>
      {title ? title : 'All Services'}
    </h1>
    <Container classList='relative z-10 md:px-5 mb-10'>
      <div className='flex flex-col items-start'>
        <p className='text-center leading-relaxed'>
          At ImageLab Med Spa, we offer a wide range of advanced, non-invasive
          treatments designed to help you achieve your beauty goals. Our expert
          team provides personalized care to address your unique needs, ensuring
          you receive the best possible experience with every visit. Whether
          you’re looking for skin rejuvenation, body contouring, or other
          aesthetic services, we have options that can be customized for you.
          Explore our full list of treatments below to discover how we can help
          you enhance your natural beauty and boost your confidence.
        </p>
      </div>
    </Container>
          ...
          <div key={j} className='relative rounded border border-gray-200'>
            {
              service?.heroImage && (
                <Image
                  ...
                  draggable='false'
                  src={builder.image(service?.heroImage?.asset)?.url()}
                  alt={
