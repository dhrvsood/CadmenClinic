...
export const PlasmicBotoxSeo__ArgProps = new Array("heroSlot");
...
function PlasmicBotoxSeo__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__k5Obf)}>
        {renderPlasmicSlot({
          ...
          <div className={classNames(projectcss.all, sty.freeBox__lGgW)}>
            ...
            >
              <BotoxMythsCard
                className={classNames(
                  "__wab_instance",
                  sty.botoxMythsCard__mpFrK
                )}
                fact={
                  "Fact: Botox only affects the muscles at the injection site, and when administered by a skilled injector, it\u2019s highly unlikely to \u201cfreeze\u201d your face. One of the biggest concerns about Botox is that it will lead to an unnatural or \u201cfrozen\u201d appearance. In reality, Botox is designed to relax specific muscles that cause wrinkles, not to paralyze your entire face. A well-trained provider can use precise injection techniques to soften lines without compromising your natural facial expressions."
                }
                number={1}
              ...
              <BotoxMythsCard
                className={classNames(
                  "__wab_instance",
                  sty.botoxMythsCard___5Z5Pk
                )}
                fact={
                  "Fact:  Botox is FDA-approved and safe when administered by a licensed, qualified provider. Botox has been extensively studied and used safely in both medical and cosmetic fields for over 30 years. The FDA approved Botox for aesthetic use in 2002, and since then, it has been widely recognized as a safe and effective treatment for wrinkles. While any procedure has potential risks, Botox side effects are usually minor, such as temporary bruising or swelling."
                }
                number={2}
