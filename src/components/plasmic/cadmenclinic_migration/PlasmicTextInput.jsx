...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: jwt5iReLG8FO/css
import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: k7xOCgbK0Irh/icon
    ...
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootsize_thick]: hasVariant($state, "size", "thick")
        }
      )}
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__e2NRe)}
              role={"img"}
            />
          ),
      ...
      <input
        ...
        className={classNames(projectcss.all, projectcss.input, sty.input, {
          ...
          [sty.inputsize_thick]: hasVariant($state, "size", "thick")
        })}
        disabled={
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__zdYpf)}
              role={"img"}
            />
          ),
