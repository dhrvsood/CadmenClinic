...
import sty from "./PlasmicBotoxLander.module.css"; // plasmic-import: 9rME71zJbGo1/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicBotoxLander.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicBotoxLander.pageMetadata.title}
        />
          ...
          <section className={classNames(projectcss.all, sty.section__qz9Z)}>
            ...
            >
              ...
              >
                ...
                >
                  {
                    "Our clients have eliminated their doubts about Botox, and you can join them today!"
                  }
                </p>
              </Stack__>
              <Stack__
              ...
              >
                ...
                <Faq
                  answer={
                    "Stopping Botox will simply return your skin to its natural state over time."
                  }
...
function makeNodeComponent(nodeName) {
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicBotoxLander";
  } else {
    func.displayName = `PlasmicBotoxLander.${nodeName}`;
  }
  return func;
}

export const PlasmicBotoxLander = Object.assign(
  // Top-level PlasmicBotoxLander renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicBotoxLander
...
export default PlasmicBotoxLander;
/* prettier-ignore-end */
