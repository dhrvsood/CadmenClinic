...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 0o-OkGmTYJg3/css
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: DK5v2vdbC2vV/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: _v0d94cDYl-T/icon
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_outlineGold]: hasVariant(
            $state,
            "color",
            "outlineGold"
          ),
          [sty.rootcolor_outlineGrey]: hasVariant(
            $state,
            "color",
            "outlineGrey"
          ),
          ...
          [sty.rootshape_rounded_color_outlineGold]:
            hasVariant($state, "color", "outlineGold") &&
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__dbAKh)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrencolor_link_size_minimal]:
              hasVariant($state, "color", "link") &&
              hasVariant($state, "size", "minimal"),
            [sty.slotTargetChildrencolor_outlineGold]: hasVariant(
              $state,
              "color",
              "outlineGold"
            ),
            [sty.slotTargetChildrencolor_outlineGrey]: hasVariant(
              $state,
              "color",
              "outlineGrey"
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__dp3HQ)}
                role={"img"}
              />
            ),
