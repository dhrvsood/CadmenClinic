...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: esEu1L6QdGZz/css
import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: 8nf5XEQxefu9/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: CT98G4OOv6EJ/icon
...
function PlasmicCheckbox__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      >
        <CheckIcon
          className={classNames(projectcss.all, sty.svg__rjx)}
          role={"img"}
        />

        <MinusIcon
          className={classNames(projectcss.all, sty.svg__yGe2)}
          role={"img"}
        />
      </div>
      {renderPlasmicSlot({
