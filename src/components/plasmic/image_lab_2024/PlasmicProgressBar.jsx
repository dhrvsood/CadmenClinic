...
import sty from "./PlasmicProgressBar.module.css"; // plasmic-import: 0_YHa4eSFPG_/css

createPlasmicElementProxy;

export const PlasmicProgressBar__VariantProps = new Array();

export const PlasmicProgressBar__ArgProps = new Array("progress");
