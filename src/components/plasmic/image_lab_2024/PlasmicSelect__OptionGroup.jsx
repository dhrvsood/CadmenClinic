...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: jhmBEdP1J2p7/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: unQKEC3an-Zq/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__cqpKm)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__nUqJ)}
              />
            </React.Fragment>
          ),
